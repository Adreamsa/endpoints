...
/**
 * Test de la capa de servicio: JUnit puro, sin Spring. Se instancia con `new` porque el
 * servicio no tiene estado ni dependencias — la recompensa de mantenerlo limpio de HTTP.
 *
 * Aqui se prueba la LOGICA DE NEGOCIO, no los codigos HTTP. Que los modelos vengan del
 * contrato no cambia nada: se construyen con su builder y se prueban igual.
 */
class PropinaServiceTest {
    ...
    void calculaPropinaYReparto() {
        ...
        // isEqualByComparingTo: para BigDecimal, 15.00 y 15.0 son iguales en valor pero
        // distintos en escala. Comparar por valor evita falsos negativos.
    ...
    void rechazaRepartoImposible() {
        // Cada campo es valido por separado; lo invalido es la combinacion.
        final CalcularPropinaRequest request = CalcularPropinaRequest.builder()
    ...
    void exponeElCatalogoCompleto() {
        // Contra Moneda.values(): si alguien agrega una moneda y olvida su descripcion,
